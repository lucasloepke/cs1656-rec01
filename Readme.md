...
> Course: **[CS 1656 - Introduction to Data Science](http://cs1656.org)** (CS 2056) -- Fall 2026  
> Instructor: Alexandros Labrinidis  
> Teaching Assistant: Evangelos Karageorgos, Modhumonty Das
>
> Recitation #1: Intro to Python
> Released: September 3, 2026  
> **Due: September 8th, 2026**

### Description
This is the **first lab** for the CS 1656 -- Introduction to Data Science (CS 2056) class, for the Fall 2026 semester.
...
xml
```
If you would like to use any other libraries, you must ask permission.
...
### What to submit
For this test assignment you only need to submit `task.py` to "Recitation Lab #1: Intro to Python" and see if you get all 100 points. In case of an error or wrong result, you can modify the file and resubmit it as many times as you want until the deadline of **Tuesday, September 8, 11:59 pm**.
